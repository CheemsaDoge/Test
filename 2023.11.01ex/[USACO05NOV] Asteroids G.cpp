/*
 * @Author: CheemsaDoge
 * @Date: 2023-11-01 10:59:16
 * @LastEditors: CheemsaDoge
 * @LastEditTime: 2023-11-01 11:31:30
 * @FilePath: \TEST\2023.11.01ex\[USACO05NOV] Asteroids G.cpp
...
signed main() {
	...
	for(int i=1;i<=_m;i++) {
		...
		add_edge(tmp1,tmp2+_n,INF);
		add_edge(tmp2+_n,tmp1,0);
	}
	write(calc());
}