 ...
 * @LastEditTime: 2023-11-08 16:14:10
 * @FilePath: \TEST\数列分块\数列分块入门1.cpp
 * @Forgive me.
...
const int MAXN=1.5e5;const int MAXB=320;const int MOD=998244353;
/*---------------------------------pre------------------------------------*/
