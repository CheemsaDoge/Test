 ...
 * @LastEditTime: 2023-11-09 20:45:53
 * @FilePath: \TEST\出题\data\sbtarzan.cpp
 * @Forgive me.
...
#include<bits/stdc++.h>
using namespace std;
const int MAXN=6.5e6;
int n,w[MAXN],b[MAXN],s[MAXN];
int f[MAXN][2];
...
signed main() {
    freopen("sbtarzan26.in","r",stdin);
    freopen("sbtarzan26.ans","w",stdout);
